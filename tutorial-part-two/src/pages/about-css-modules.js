...
const User = props => (
    <div className={styles.user}>
        <img src={props.avatar} className={styles.avatar} alt="avatar utilisateur" />
    ...
    return (
        <Container>
            ...
            <User
                ...
                excerpt="I'm Kevin. Lorem ipsum dolor sit amet, consectetur adipisicing elit."
            />
            <User
                username="Agathe"
                ...
                excerpt="I'm Agathe. Lorem ipsum dolor sit amet, consectetur adipisicing elit."
            />
        </Container>
    )
}